    ...
    //选择问题1后显示选择信息
     ...
     for(var c = 0;c<check_training_object.length;c++){
        if(check_training_object[c].checked){
            selected_message_one=selected_message_one+check_training_object[c].value+",";
            for(var i = 0;i<type.length;i++){
                if(check_training_object[c].value===type[i].name){
                    ...
                    for(var j = 0;j<child_list.length;j++){
                        ...
                        if(child_list[j].is_leaf===1){
                              ...
                              var leaf_radio=$("<input type='radio'/>");
                        ...
                        if(child_list[j].is_leaf===0){
                          console.log("非叶子节点")
                            ...
                            //   var un_leaf_title=$("<div class='investigation_un_leaf_title'>"+child_list[j].name+"</div>");
                              ...
                              var un_leaf_radio=$("<input type='radio'/>");
                            ...
                            //   $("#direction_box").append(un_leaf_title);
